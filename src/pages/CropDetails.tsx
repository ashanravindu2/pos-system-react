        ...
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-40 ml-4  ">
                ...
                <div className="bg-white rounded-lg  overflow-hidden shadow-2xl ">
                    <img src="src/assets/dashboardImg/Screenshot 2025-01-14 001410.png" alt="crop details Image"
                         className="w-full h-40 object-cover"/>
                    <div className="p-4">
                        <p className="text-gray-600 text-sm font-semibold">Log Code</p>
                        <p className="text-gray-800 font-medium truncate">F-52d02329-a257-4854...</p>
                        <p className="text-gray-600 text-sm font-semibold mt-2">Log Date</p>
                        <p className="text-gray-800 font-medium truncate">2025.01.14</p>
                    </div>
                    ...
                    <div className="flex flex-row items-center gap-4 action mb-2">
                            ...
                            <svg
                                ...
                                viewBox="0 0 20 14"
                                fill="none"
                                onClick={() => setShowViewCropDetails(true)}
            ...
            {/*popup add quip*/}
            {PopupSaveVisible && <CropDetailsSavePopUp onClose={() => setShowSave(false)}/>}
            {PopUpUpdateVisible && <CropDetailsUpdatePopUp onClose={() => setShowUpdate(false)}/>}
            {PopUpViewStaffVisible && <ViewCropDetailsPopUp onClose={() => setShowViewCropDetails(false)}/>}
