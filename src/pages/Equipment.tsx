...
export function Equipment() {
    ...
    return (
        <>
            ...
            <div className=" flex justify-center mt-52 ml-10 ">
                <div className="">
                    <div className="grid grid-cols-6 gap-4 border-b pb-2 p-2 ">
                        <h5 className="flex flex-col items-center">Equipment Id</h5>
                        <h5 className="flex flex-col items-center">Name</h5>
                        <h5 className="flex flex-col items-center">Equipment Type</h5>
            ...
            {/*popup add quip*/}
            {PopupSaveVisible && <EquipmentSavePopUp onClose={() => setShowSave(false)}/>}
            {PopUpUpdateVisible && <EquipmentUpdatePopUp onClose={() => setShowUpdate(false)}/>}
            {PopUpViewStaffVisible && <ViewEquipPopUp onClose={() => setShowViewEuip(false)}/>}
