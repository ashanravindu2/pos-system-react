...
import {FieldSavePopUp} from "../components/FieldSavePopUp.tsx";
import {FieldUpdatePopUp} from "../components/FieldUpdatePopUp.tsx";
import {ViewFieldPopUp} from "../components/ViewFieldPopUp.tsx";
...
export function Field() {
    ...
    const [fieldToDelete, setFieldToDelete] = useState<string | null>(null); //delete eka mekem ghnnone
    ...
    const handleDelete = (fieldId: string) => {
        setFieldToDelete(fieldId); // Set the staff ID for deletion
        handleDeleteData(fieldId , 'Field'); // Call the delete confirmation popup
    };
