interface EquipViewPopUpProps {
    onClose: () => void;
}

export function ViewEquipPopUp({ onClose }: EquipViewPopUpProps) {
    return (
        <>
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white rounded-lg shadow-lg p-8 w-[600px]">
                    <h2 className="text-xl font-bold mb-4 text-center">View Equipment</h2>

                    {/*  Id */}
                    <div className="flex flex-col">
                        <label className="text-sm font-semibold mb-1">Equipment ID</label>
                        <input
                            type="text"
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        {/* field */}
                        <div className="flex flex-col">
                            <label className="text-sm font-semibold mb-1">Assign Field</label>
                            <input
                                type="text"
                                className="border border-gray-300 rounded px-3 py-2"
                                placeholder="feild"
