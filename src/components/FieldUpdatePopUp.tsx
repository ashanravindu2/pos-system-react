interface FieldUpdatePopUpProps {
    onClose: () => void;
}

export function FieldUpdatePopUp({ onClose }: FieldUpdatePopUpProps) {
    function onSave() {
        return () => {
        ...
        <>
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white rounded-lg shadow-lg p-8 w-[600px]">
                    <h2 className="text-xl font-bold mb-4 text-center">Update Field</h2>
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col">
                            <label className="text-sm font-semibold mb-1">Select Staff Member</label>
