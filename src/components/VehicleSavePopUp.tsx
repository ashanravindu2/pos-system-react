interface VehicleSavePopUpProps {
    onClose: () => void;
}

export function VehicleSavePopUp({ onClose }: VehicleSavePopUpProps) {
        ...
        <>
            <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                <div className="bg-white rounded-lg shadow-lg p-8 w-[600px]">
                    <h2 className="text-xl font-bold mb-4 text-center">Add New Vehicle</h2>
